...
export default function SectionTitle({ label, title, subtitle }: SectionTitleProps) {
    return (
        <div className="mb-12 text-center relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white dark:text-white light:text-zinc-900 mb-3 leading-tight">
                {title}
            </h2>
            {subtitle && (
                <p className="text-zinc-400 dark:text-zinc-400 light:text-zinc-600 text-base md:text-lg max-w-xl mx-auto leading-relaxed">
                    {subtitle}
                </p>
            )}
        </div>
