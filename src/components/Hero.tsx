export default function Hero() {
    return (
        <section
            id="home"
            className="min-h-screen flex items-center justify-center bg-transparent pt-16 relative z-10"
        >
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                {/* Role */}
                <p className="text-xl md:text-2xl font-semibold text-zinc-300 mb-6">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
                    ...
                    <a
                        href="#contact"
                        className="w-full sm:w-auto px-7 py-3.5 bg-zinc-900 text-zinc-100 font-semibold rounded-2xl border border-zinc-800 hover:border-indigo-500/50 hover:text-indigo-400 transition-all duration-200 shadow-sm hover:shadow-md hover:-translate-y-0.5 text-sm"
                    >
                        Contact Me
                    </a>
                    <a
                        ...
                        className="w-full sm:w-auto flex items-center justify-center gap-2 px-7 py-3.5 bg-zinc-900 text-white font-semibold rounded-2xl border border-zinc-800 hover:bg-zinc-800 transition-all duration-200 shadow-sm hover:shadow-md hover:-translate-y-0.5 text-sm"
                    >
                ...
                {/* Scroll indicator */}
                <div className="mt-20 flex flex-col items-center gap-2 text-zinc-500 animate-bounce">
